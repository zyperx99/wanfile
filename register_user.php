            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form">
                            ...
                            <h3 class="form-title"> Click <a href="register_staff.php">here</a> to staff registration.</h3>
                        </form>
                    </div>
                ...
                <?php
                        ...
                        if (isset($_POST["signup"]))
                        {
                            ...
                            echo '</script>';
                            echo ' Click <a href="login_user.php">here</a> to login.';
                            ...
                            echo '<strong>Status!</strong> Username already exists. Click <a href="register_user.php">here</a> to try again.';   
