    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="staff_profile.php">Staff Dashboard</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
            ...
            <!-- Basic Table -->
                    <div class="card card-about-me">
                        ...
                        <div class="body">
                            ...
                            <?php 
                            $userid = $_SESSION["pbt_userid"];
                            $user = "SELECT PBT_Ic, PBT_Name, PBT_Position, PBT_Address, PBT_No FROM pbt WHERE PBT_ID = $userid";
