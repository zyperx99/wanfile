...
<head>
    ...
    <title>Cleanliness of bin report</title>
    <!-- Favicon-->
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.php">Staff - Service satisfaction report</a>
            </div>
        </div>
    </nav>
    <!-- #Top Bar -->
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <small>This is data that already been rated by the user towards system service and user satisfaction</small>
                            </h2>
    <!------------------------------------graph generation-------------------------->
            <br>
            <br>
